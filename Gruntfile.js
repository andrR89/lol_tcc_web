module.exports = function (grunt) {
        ...
        copy: {
            ...
            dist: {
                files: [
                    ...
                    {
                        expand: true, cwd: '<%= pkg.garbageDir %>/src', src: ['**', '!*.js'], dest: '<%= pkg.distDir %>'
                    },
                    {
                        expand: true, cwd: '<%= pkg.garbageDir %>/lib', src: ['**'], dest: '<%= pkg.distDir %>/lib'
                    },
                    // Copia todo o build para o diretorio /dist
                    {
                        expand: true,
                        cwd: '<%= pkg.garbageDir %>',
                        src: ['**', '!src/**', '!lib/', '!stylesheet.css', '!scripts.js'],
                        dest: '<%= pkg.distDir %>'
                    }
                ]
            }
    ...
    grunt.registerTask('run', ['dist', 'connect:dist:keepalive']);
}           